...
import TableProductoSelecionar from "./components/TableProductoSelecionar";
          ...
          <div className="border-indigo-300 border-x border-y p-3 rounded-2xl min-h-[560px] flex flex-col gap-4 justify-between">
            <div className="text-center">
              <label className="inline-flex items-center cursor-pointer ">
                ...
                />
                <div className="relative w-12 h-[26px] bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
            ...
            <div className="text-center border-t pt-3">
              <button
                ...
                className="text-white  disabled:opacity-60 bg-gradient-to-r from-indigo-400  disabled:cursor-not-allowed via-indigo-500 to-indigo-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:focus:ring-red-800 shadow-lg font-medium rounded-lg  px-3 py-1.5 text-center me-2 mb-2"
              >
                Agregar Producto
              </button>
            </div>
